...
namespace Vakcina.WPF.Repositories
{
    public class VakcinaContext
    {
        ...
        {
            Oltasok = GenerateData();
        }

        #region Memóriában lévő orvos adatok
        public IEnumerable<orvos> Orvosok = new List<orvos>()
        {
            new orvos()
            {
                id = 1,
        ...
        #region Memóriában lévő vakcina adatok
        public IEnumerable<vakcina> Vakcinak = new List<vakcina>()
        {
            new vakcina()
            {
                id = 1,
        ...
        #region Memóriában lévő oltás adatok
        public IEnumerable<oltas> Oltasok;

        private List<oltas> GenerateData()
        {
            var oltasok = new List<oltas>();
